...
import os
import sys
sys.path.insert(0, os.path.abspath('C:/Users/JAKEFREDRICH/Desktop/Data Science/GitRepo/Data_Science_Projects/notebooks'))
...
copyright = '2020, Jake Fredrich'
author = 'Jake Fredrich'
